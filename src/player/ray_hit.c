...
/*   Updated: 2024/09/03 16:28:17 by freesca          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_ray_hit_x(t_point *hit_point, t_ray *ray,
		t_point delta_point, double dir_angle)
{
...
void	ft_ray_hit_y(t_point *hit_point, t_ray *ray,
		t_point delta_point, double dir_angle)
{
...
t_point	ft_ray_hit(t_var *var, t_point delta_point,
		t_ray *ray, double dir_angle)
{
	t_point	hit_point;
